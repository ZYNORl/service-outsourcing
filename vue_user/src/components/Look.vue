    ...
    <div style="width:100%;height:100%;padding-top: 30px;margin-left: -100px">
        <el-collapse v-model="activeNames" @change="handleChange">
            <el-collapse-item title="企业信息" name="1">
                <div id="leiDaTu" style="width: 750px;height: 750px; margin: 0 auto"><span>个人职业素质画像</span></div>
            </el-collapse-item>
        </el-collapse>
            ...
            <div class="block">
                <el-timeline>
                            ...
                            <el-row :gutter="0">
                                <el-col>
                                    <div style="margin: 5px 40px">
                                        <p>{{record.userInfo.user.evaluation}}</p>
                                    </div>
                                    <div style="margin: 5px 40px">
                                        <p>{{record.userInfo.user.hobby}}</p>
                                    </div>
                                </el-col>
                            </el-row>
                        </el-card>
                    ...
                    <el-timeline-item timestamp="专业技能" placement="top">
                        <el-card >
                            <el-row :gutter="200">
                                <el-col :span="400" v-for='(item,index) in this.record.userInfo.domainSkills' :key="index">
                                    <p>{{item.text}}</p>
                                </el-col>
                            </el-row>
                        </el-card>
...
<script>
    export default {
        ...
        methods:{
            async getRecord(){
                this.queryComId.userid = window.sessionStorage.getItem("userId")
                const {data:ans}=await this.$http.get('getComIdByUserId',{params:this.queryComId})
                this.queryInfo.comid = ans
