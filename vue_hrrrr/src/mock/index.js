...
Mock.mock('http://localhost:83/api/getMenus','get',{
    ...
    data:[{
        ...
        id:103,
        authName:'招聘管理',
        children:[{authName:'发布招聘',children:null,path:'zhaopin'},{authName:'搜索简历',children:null,path:'searchRecord'}]
    },{
        id:101,
        authName:'出勤管理',
        children:[{authName:'出勤列表',children:null,path:'attendances'}]
    },{
        id:145,
        authName:'企业中心',
        children:[{authName:'企业信息',children:null,path:'details'}]
    }]
})
