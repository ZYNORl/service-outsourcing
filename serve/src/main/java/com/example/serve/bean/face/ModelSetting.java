package com.example.serve.bean.face;
...
public class ModelSetting {
    ...
    public String toString() {
        ...
        sb.append(",\"Quality_Control\":\"")
                .append(Quality_Control).append('\"');
        sb.append(",\"Image_Type\":\"")
                .append(Image_Type).append('\"');
        sb.append(",\"Liveness_Control\":\"")
                .append(Liveness_Control).append('\"');
        sb.append(",\"Userinf\":\"")
                .append(Userinf).append('\"');
        sb.append('}');
        return sb.toString();
    }
}
